...
- **Remote file management** tools allowing safe file creation, printing, line-range replacement, and exact line lookups via the `manage_file` tool and `filetool` client command.
